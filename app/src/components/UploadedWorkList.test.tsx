...
interface Work { id: string; summary: string; dateUploaded: string; dateCompleted: string | null; tags: string[] }
...
describe('UploadedWorkList', () => {
  ...
  it('loads works on mount', async () => {
    ...
    mockGet([{ id: '1', summary: 'sum', dateUploaded: new Date().toISOString(), dateCompleted: null, tags: ['t1','t2'] }])
